<?php include(APPPATH."views/includes/header.php");?>
    ...
    <div class="modal fade" id="viewsingle-sallary" role="dialog">
       ...
       <div class="modal-content">
        ...
        <div class="modal-body">
           <div class="row">
                ...
                <!-- progress bar area -->
                <div class="progress" id="progress-single" style="height:40px;display:none;">
                   <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width:100%;line-height:40px;">
                    please wait...
                    </div>
                </div>
                <!-- end of progress bar area -->
                  <table id="payroll" aria-describedby="dataTables-example_info" class="table table-striped table-hover">
  ...
  <!-- end of single room view modal -->
    ...
    <script type="text/javascript" src="theme/js/admin/accountssallaryfilter.js"></script>
