            ...
            <div class="container-fluid">
                ...
                <div class="row">
                 <div id="message" style="visibility:hidden;"></div>
                    <form enctype="multipart/form-data" id="asset">
                     <div class="col-xs-12">
                         <div class="col-md-12 well">
                            <div class="row">
                                <div class="col-md-6"><div class="form-group"><label class="pull-left">Name:</label><input type="text" name="name" class="form-control"><span class="name"></span></div></div>
                            ...
                            <input type="submit" value="Submit"  name="add-asset" class="btn btn-primary pull-right">
                         </div>
                    </div>
                    </form>
                </div>
