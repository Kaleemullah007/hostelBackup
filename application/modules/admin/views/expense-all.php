<?php include(APPPATH."views/includes/header.php");?>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Assets Records
                            <a href="add-expense" class="btn btn-outline btn-warning pull-right editbutton">Add New</a>
                        </div>
                        <!-- /.panel-heading -->
       ...
       <div class="modal-content">
        ...
        <div class="modal-body">
           <div class="row">
                <div class="col-lg-12">
                  <div id="message" style="visibility:hidden;"></div>
                    <form enctype="multipart/form-data" id="expenseupdate">
                     <div class="col-xs-12">
                         <div class="col-md-12 well">
                            ...
                            <input type="submit" value="Submit"  name="update-expense" class="btn btn-primary pull-right">
                         </div>
                    </div>
                    </form>
                </div>
  ...
  <!-- end of update asset modal -->
    ...
    <div class="modal fade" id="viewsingle-expense" role="dialog">
     <div class="modal-dialog">
      <!-- Modal content-->
       <div class="modal-content">
        <div class="modal-header modal-header">
