...
<body>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading" style="background:#f5f5f5;border:0px;">
                        <h3 class="panel-title"> <img src="theme/images/admin-logo.png" class="img-responsive"></h3>
                    </div>
                    <div class="panel-body">
                        <form role="form" id="login">
                            ...
                            <div id="message"></div>
                                ...
                                <input type="submit" name="login" value="Login" class="btn btn-custom btn-block btn-lg">
                            </fieldset>
                        </form>
                    </div>
                </div>
    ...
    <div id="url" class="admin-login-validate"></div>
    <!-- jQuery -->
