<?php include(APPPATH."views/includes/header.php");?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <!-- end of row -->
               <div class="row border inner-top-20">
                     <div class="col-md-3">
                       <img src="theme/images/profile.jpg" class="img-responsive outer-bottom-20">
                       </div>
                   <!-- end of profile -->  
                   <!-- <div class="col-md-2"> -->
                       <!-- <ul class="nav nav-pills">
                          <li class="active"><a href="#home" data-toggle="pill">Personal Details</a></li>
                          <li><a href="#aboutus" data-toggle="pill">Acedemic Details</a></li>
                          <li><a href="#" data-toggle="pill">Visitors Details</a></li>
                          <li><a href="#" data-toggle="pill">Fee & Voucher</a></li>
                          <li><a href="#" data-toggle="pill">Account Settings</a></li>
                        </ul> -->
                   <!-- </div> -->
